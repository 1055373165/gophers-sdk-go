...
func (a *GophersAPIService) CheckHealthExecute(r ApiCheckHealthRequest) (*http.Response, error) {
	var (
...
func (r ApiGophersGetRequest) Execute() (*http.Response, error) {
...
// Execute executes the request
func (a *GophersAPIService) GophersGetExecute(r ApiGophersGetRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
